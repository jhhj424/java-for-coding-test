...
public class StringFlipTest {
    ...
    @Test
    public void toTest() {
        StringFlip stringFlip = new StringFlip();
        String s1 = "0001100";
        String s2 = "0001101110011011011";
        assertThat(stringFlip.toTest(s1), is(1));
        assertThat(stringFlip.toTest(s2), is(5));
    }
}