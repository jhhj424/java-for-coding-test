 ...
 */
public class AdventurersGuildTest {

    @Test
    public void adventurersGuildToTest() {
        AdventurersGuild adventurersGuild = new AdventurersGuild();
        // 모험가의수 5
        int n = 5;
        // 각 모험가의 공포도 값
        int[] m = {2, 3, 1, 2, 2};
        // 답안 예시 : 2
        assertThat(adventurersGuild.AdventurersGuildToTest(n,m), is(2));

        // 모험가의수 12
        n = 12;
        // 각 모험가의 공포도 값
        int[] m2 = {2, 3, 1, 2, 2, 4, 3, 2, 2, 4, 3, 2};
        // 답안 예시 : 5
        assertThat(adventurersGuild.AdventurersGuildToTest(n,m2), is(5));

        // 모험가의수 20
        n = 20;
        // 각 모험가의 공포도 값
        int[] m3 = {2, 3, 1, 2, 2, 2, 3, 1, 2, 2, 2, 3, 1, 2, 2, 2, 3, 1, 2, 2};
        // 답안 예시 : 5
        assertThat(adventurersGuild.AdventurersGuildToTest(n,m3), is(11));
    }
}