 ...
 */
public class EatingRoomLiveOfMujiSample {

    private static PriorityQueue<Foo> pq = new PriorityQueue<>();
    private static ArrayList<Foo> list = new ArrayList<>();
    // 이미 먹은 시간
    private static int prev_time = 0;

    public static void main(String[] args) {
        int[] i = {3,1,2};
        long k = 5;
        System.out.println(EatingRoomLiveOfMujiSample.solution(i, k));
    }
